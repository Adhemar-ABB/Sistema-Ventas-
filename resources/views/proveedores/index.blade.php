        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-1 text-xs md:text-sm text-gray-500 dark:text-gray-400">
                    Administra y organiza los proveedores registrados
                </p>
            </div>
            ...
            <nav class="mt-4 md:mt-0" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm">
                    ...
                    <li class="flex items-center">
                        ...
                        <span class="text-gray-500 dark:text-gray-400">Proveedores</span>
                    </li>
                    <li class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400 mx-2 text-xs"></i>
...
<div class="mt-6 flex items-center justify-end w-full">
    <div class="relative w-full max-w-xs">
        <input id="buscarProveedor"
            type="text"
            placeholder="Buscar..."
            class="w-full pl-10 pr-4 py-2 text-sm rounded-lg border border-gray-300 bg-white text-gray-700
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs mt-3 px-6">
        <div class="w-full overflow-x-auto">
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                {{-- Tabla de de proveedores --}}
                <div class="p-4">
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">

                            <table id="tablaProveedores"  class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                    ...
                                    @forelse ($proveedores as $proveedor)
                                        <tr
                                            ...
                                            <td class=" py-2 text-center flex gap-5 ">
                                                ...
                                                {{-- Eliminar --}}
                                                <form  class="formProveedor"   action="{{ route('proveedores.destroy', $proveedor->id) }}"
                                                    method="POST" >
...
<script>
    document.querySelectorAll(".formProveedor").forEach(form => {
        form.addEventListener("submit", function(e) {
            e.preventDefault();

            Swal.fire({
                title: "¿Estás seguro?",
                text: "Este proveedor será anulado.",
                icon: "warning",
