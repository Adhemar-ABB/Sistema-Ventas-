<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-1 text-xs md:text-sm text-gray-500 dark:text-gray-400">
                    Administra y organiza tus marcas de los productos
                </p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="p-4">
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            <table id="tablaMarcas" class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                 ...
                                 dark:bg-black dark:text-white dark:border dark:border-red-500">
                                            ...
                                            <td class="py-2 text-center flex gap-5">
                                                ...
                                                {{-- Eliminar --}}
                                                <form  class="formMarcas"  action="{{ route('marcas.destroy', $marca->id) }}"
                                                    method="POST">
 ...
 <script>
        document.addEventListener("DOMContentLoaded", function() {
            const input = document.getElementById("buscarMarca");
...
<script>
    document.querySelectorAll(".formMarcas").forEach(form => {
        form.addEventListener("submit", function(e) {
            e.preventDefault();

            Swal.fire({
                title: "¿Estás seguro?",
                text: "Esta marca será anulada.",
                icon: "warning",
