                ...
                <div class="p-4">
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            ...
                            <table  id="tablaClientes" class="w-full whitespace-no-wrap text-gray-800 dark:text-white">
                                <thead>
                                    <tr
                                    ...
                                    @forelse ($clientes as $cliente)
                                        <tr
                                            ...
                                            <td class=" py-2 text-center flex gap-5 ">
                                                ...
                                                {{-- Eliminar --}}
                                                <form   class="formCliente" action="{{ route('clientes.destroy', $cliente->id) }}"
                                                    method="POST">
...
<script>
    document.querySelectorAll(".formCliente").forEach(form => {
        form.addEventListener("submit", function(e) {
            e.preventDefault();

            Swal.fire({
                title: "¿Estás seguro?",
                text: "Este cliente será anulado.",
                icon: "warning",
