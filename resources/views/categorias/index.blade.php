    ...
    <div class="px-6 py-2 border-b border-gray-100 dark:border-gray-700">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="p-5 text-xs md:text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="p-4">
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                            <table id="tablaCategorias" class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                 ...
                                 dark:bg-black dark:text-white dark:border dark:border-red-500">
                                            ...
                                            <td class="py-2 text-center flex gap-5">
                                                ...
                                                {{-- Eliminar --}}
                                                <form class="formCategoria" action="{{ route('categorias.destroy', $categoria->id) }}"
                                                    method="POST">
...
<script>
    document.querySelectorAll(".formCategoria").forEach(form => {
        form.addEventListener("submit", function(e) {
            e.preventDefault();

            Swal.fire({
                title: "¿Estás seguro?",
                text: "Esta categoría será anulada.",
                icon: "warning",
